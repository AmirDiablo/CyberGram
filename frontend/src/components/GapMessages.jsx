...
const GapMessages = ({chatId, theme}) => {
    ...
    useEffect(()=> {
            ...
            console.log("sdlkcnlksdnclbsdjcbkjdsbckjbsdkjcbksd")
    ...
    return ( 
        <div ref={scrollRef} className="chatMessage hideScroll" style={{position: "relative"}} onClick={closeActions} onScroll={handleScroll}>
